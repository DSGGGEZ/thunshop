...
?>
    ...
    <a href="addcus.php" class="btn btn-info pull-right" style="margin-left: 10px">Add </a><h4>
    <div>
    </div>
    <br>
</div>
        ...
        while($row = $results->fetch_assoc()) {
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="editcus.php?idcustomer=<?php echo $row['idcustomer'] ?>" class="btn btn-sm btn-info">
                        <span class="glyphicon glyphicon-edit"></span>
                    <a href="deletecus.php?idcustomer=<?php echo $row['idcustomer'] ?>" class="btn btn-sm btn-danger">
